...
data_dir = "../../../../data/ccpc/7th/harbin-warmup"
...
config = {
    'contest_name': '第 7 届中国大学生程序设计竞赛（CCPC）哈尔滨站 - 热身赛',
    'start_time': get_timestamp("2021-11-27 15:30:00"),
    'end_time': get_timestamp("2021-11-27 17:30:00"),
    'frozen_time': 30 * 60,
