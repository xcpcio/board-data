...
def handle_teams(teams: Teams):
    ...
    for t in teams.values():
        ...
        if "NE-A" in d_team["group_ids"]:
            t.group.append("NE-A")
        elif "NE-B" in d_team["group_ids"]:
            t.group.append("NE-B")
        elif "NE-female" in d_team["group_ids"]:
            t.group.append("NE-female")
        elif "NE-star" in d_team["group_ids"]:
            t.group.append("NE-star")
        else:
            filter_team_id.append(t.team_id)
