...
data_dir = "../../../../data/provincial-contest/2023/wuhan"
...
config = {
    'contest_name': '第五届湖北省大学生程序设计竞赛（正式赛）',
    'start_time': get_timestamp("2023-4-30 10:00:00"),
    'end_time': get_timestamp("2023-4-30 15:00:00"),
    'frozen_time': 60 * 60,
