...
data_dir = "../../../../data/provincial-contest/2021/sdcpc/"
...
config = {
    'contest_name': '第十一届山东省大学生程序设计竞赛(正式赛）',
    'start_time': get_timestamp("2021-5-9 10:00:00"),
    'end_time': get_timestamp("2021-5-9 15:00:00"),
    'frozen_time' : 60 * 60,
