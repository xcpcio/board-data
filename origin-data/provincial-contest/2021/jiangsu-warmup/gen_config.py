...
data_dir = "../../../../data/provincial-contest/2021/jiangsu-warmup"
...
config = {
    'contest_name': '2021 年江苏省大学生程序设计大赛 - 热身赛',
    'start_time': get_timestamp("2021-12-24 18:30:00"),
    'end_time': get_timestamp("2021-12-24 20:30:00"),
    'frozen_time': 60 * 30,
    ...
    'logo': {
        'base64': urltobase64('./logo/ccpc_logo.png')
    }
}
