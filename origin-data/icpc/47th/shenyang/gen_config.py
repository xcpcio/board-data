...
data_dir = "../../../../data/icpc/47th/shenyang"
...
config = {
    'contest_name': '第 47 届国际大学生程序设计竞赛亚洲区域赛沈阳站（正式赛）',
    'start_time': get_timestamp("2022-11-6 12:00:00"),
    'end_time': get_timestamp("2022-11-6 17:00:00"),
    'frozen_time': 60 * 60,
