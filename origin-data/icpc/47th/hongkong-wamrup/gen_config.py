...
default_balloon_color = [
    ...
    {'background_color': '#008000', 'color': '#fff'},
]

data_dir = "../../../../data/icpc/47th/hongkong-warmup"
...
config = {
    'contest_name': '第 47 届国际大学生程序设计竞赛亚洲区域赛香港站（热身赛）',
    'start_time': get_timestamp("2023-1-14 9:30:00"),
    'end_time': get_timestamp("2023-1-14 11:00:00"),
    'frozen_time': 30 * 60,
