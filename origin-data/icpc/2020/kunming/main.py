...
raw_dir = "raw"
data_dir = "../../../../data/icpc/2020/kunming"
problem_num = 13
...
config = {
    'contest_name': '第 45 届国际大学生程序设计竞赛（ICPC）亚洲区域赛（昆明）正式赛',
    'start_time': get_timestamp("2021-4-3 11:00:00"),
    'end_time': get_timestamp("2021-4-3 16:00:00"),
