...
def generate_balloon_color(num):
    default_balloon_color = [
        ...
        {'background_color': '#002329', 'color': '#fff'},
    ]
    
    return default_balloon_color[:num]

data_dir = "../../../../data/icpc/2019/yinchuan"
...
config = {
    'contest_name': 'The 44th ICPC Asia Yinchuan Regional Programming Contest',
    'start_time': get_timestamp("2019-10-20 9:00:00"),
    'end_time': get_timestamp("2019-10-20 14:00:00"),
    'frozen_time' : 60 * 60,
