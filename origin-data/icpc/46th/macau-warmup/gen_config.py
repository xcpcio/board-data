...
data_dir = "../../../../data/icpc/16th/macau-warmup"
...
config = {
    'contest_name': '第 46 屆 ICPC 東亞洲區域賽（澳門）熱身賽',
    'start_time': get_timestamp("2022-4-3 9:30:00"),
    'end_time': get_timestamp("2022-4-3 10:30:00"),
    'frozen_time': 0 * 60,
