...
data_dir = "../../../../data/icpc/46th/shanghai"
...
config = {
    'contest_name': '第 46 届 ICPC 国际大学生程序设计竞赛亚洲区域赛（上海）正式赛',
    'start_time': get_timestamp("2021-11-28 11:00:00"),
    'end_time': get_timestamp("2021-11-28 16:00:00"),
    'frozen_time': 60 * 60,
