...
DATA_DIR = os.getenv(
    "DATA_DIR", "../../../../../data/camp/tsinghua/2024/day1")
FETCH_URI = os.getenv(
    "FETCH_URI", "")
...
if __name__ == "__main__":
    c = get_basic_contest()
    c.contest_name = "Tsinghua Bootcamp 2024. Day1"
    c.start_time = utils.get_timestamp_second("2024-08-20 10:00:00")
    c.end_time = utils.get_timestamp_second("2024-08-20 15:00:00")
