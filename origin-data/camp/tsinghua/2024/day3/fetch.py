...
DATA_DIR = os.getenv(
    "DATA_DIR", "../../../../../data/camp/tsinghua/2024/day3")
FETCH_URI = os.getenv(
    "FETCH_URI", "")
...
if __name__ == "__main__":
    c = get_basic_contest()
    c.contest_name = "Tsinghua Bootcamp 2024. Day3"
    c.start_time = utils.get_timestamp_second("2024-08-22 10:00:00")
    c.end_time = utils.get_timestamp_second("2024-08-22 15:00:00")
