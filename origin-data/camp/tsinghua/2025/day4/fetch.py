...
DATA_DIR = os.getenv(
    "DATA_DIR", "../../../../../data/camp/tsinghua/2025/day4")
FETCH_URI = os.getenv(
    "FETCH_URI", "")
...
if __name__ == "__main__":
    c = get_basic_contest()
    c.contest_name = "Tsinghua Bootcamp 2025. Day 4"
    c.problem_quantity = 13
    c.start_time = utils.get_timestamp_second("2025-08-08 10:00:00")
    c.end_time = utils.get_timestamp_second("2025-08-08 15:00:00")
